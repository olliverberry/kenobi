...
export class PovsService {
  private readonly povs: any[] = [
    ...
    },
    {
      ...
      deployments: [{ name: "Main Org", url: "https://semgrep.dev/orgs/techstart-main" }],
    },
    {
      id: "pov-003",
    ...
    },
    {
      ...
      deployments: [{ name: "Production", url: "https://semgrep.dev/orgs/devtools-prod" }],
    },
  ]
  ...
  getPov(povId: string): any {
    return this.povs.find((pov) => pov.id === povId);
  }
}
